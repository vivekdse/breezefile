...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    verbs: [
      ...
      { name: 'claude / codex / gemini', what: 'open the terminal pane and launch the AI CLI · pick a Mode (Bare / Continue / Skip-permissions) when the launcher has variants · backgrounded tabs badge when waiting for input · dock badge + system notification when Breeze is in the background (toggles in Settings → Notifications)' },
