...
const SLIDES: Slide[] = [
  ...
  },
  {
    ...
    verbs: [
      ...
      { name: 'revert', what: 'discard unsaved changes and reload the file from disk (prompts if dirty)' },
  ...
  },
  {
    ...
    verbs: [
      ...
      { name: 'sidebar indicators', what: 'Active Tasks sidebar shows per-task glyphs: due-now dot, running spinner, last-run-failed dot, ⚡ for auto · tasks anchored to the folder you’re browsing float to the top with a distinct folder icon + accent rail · right-click for Edit / Mark done / Pin / Snooze / Run now / View run history / Open last run in new tab / Delete' },
