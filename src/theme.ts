...
/** Ordered catalog driving the Restyle popover grid in the mockup. */
export const THEMES: readonly ThemeMeta[] = [
  { id: 'paper', label: 'Paper', swatch: ['#fbf6ea', '#ebe3ce', '#a3391a'] },
  { id: 'pastel', label: 'Pastel', swatch: ['#fef8f6', '#f1dfd9', '#b56b7c'] },
  { id: 'feminism', label: 'Pink Feminism', swatch: ['#f9f5f8', '#e7dde4', '#c04673'] },
  { id: 'orchid', label: 'Pink Orchid', swatch: ['#fef6f4', '#f0cfcb', '#7a1f2f'] },
  { id: 'garden', label: 'Pink Garden', swatch: ['#fcf1ed', '#f2d9cf', '#2f5a3e'] },
  { id: 'linen', label: 'Linen', swatch: ['#f1ecdf', '#dcd5c0', '#7d8a6e'] },
  { id: 'sakura', label: 'Sakura', swatch: ['#fbf4f4', '#ecd9da', '#b26a6a'] },
  { id: 'dawn', label: 'Dawn', swatch: ['#faf2f2', '#ecdfe3', '#c85b40'] },
  {
    id: 'feminism-night',
    label: 'Feminism Night',
    swatch: ['#2a1a30', '#faeff2', '#c1378b'],
  },
