...
export function browserSubagentMarkdown(): string {
  ...
  return [
    ...
    '      `me.taxId`, `me.availity.login`, or location-scoped `me.npi.<location>`)',
    '      via `fill-ref`/`type-ref`. Breeze resolves it from the user\'s saved',
    '      credentials. USE the `me.*` ref — do NOT ask the human for these or',
    '      expect them inline in the task body.',
