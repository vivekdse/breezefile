...
function playbookBody(): string[] {
  ...
  return [
    ...
    '  PROMOTION HOOK: after a full-agent solve of a REUSABLE flow, EMIT a tool',
    '  (next item) so the next run lands at tier 2 — this is how novel pages',
    '  graduate out of the slow path.',
    '',
    '5. LEARN (promotion) — when raw driving solves something REUSABLE, package it',
    '  as a tool so it graduates to tier 2 (stage in a mktemp dir, then',
